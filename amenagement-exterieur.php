...
<head>
	<meta charset="UTF-8">
	<title>SENEŌ - Aménagement Extérieur</title>
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
	<meta name="description" content="SENEŌ - Aménagement Extérieur"/>
...
<body>
	...
	<section>
		<div class="banner">
			<div class="deZoomBg" data-background="img/amenagement-exterieur-banner.jpg"></div>
		</div>
					...
					<div class="row">
						<div class="col-12 col-md-6 col-lg-4">
							<div class="content-img-text">
								...
								<p class="paragraphe big-p text-center">Brumisation</p>
							</div>
						</div>
						<div class="col-12 col-md-6 col-lg-4">
							<div class="content-img-text">
						...
						<div class="col-12 col-md-6 col-lg-4">
							<div class="content-img-text">
								<img src="img/ae-rocher-reconstitue.jpg" alt="Photo Aménagement Extérieur">
								<p class="paragraphe big-p text-center">Rocher reconstitué</p>
							</div>
						</div>
						<div class="col-12 col-md-6 col-lg-4">
							<div class="content-img-text">
								<img src="img/ae-chukum.jpg" alt="Photo Aménagement Extérieur">
								<p class="paragraphe big-p text-center">Chukum, revêtement<br> naturel éco-responsable</p>
							</div>
						</div>
						<div class="col-12 col-md-6 col-lg-4">
							<div class="content-img-text">
						...
						<div class="col-12 col-md-6 col-lg-4">
							<div class="content-img-text">
								<img src="img/ae-salon-inte-exte.jpg" alt="Photo Aménagement Extérieur">
								<p class="paragraphe big-p text-center">Salon intérieur/extérieur</p>
							</div>
						</div>
						<div class="col-12 col-md-6 col-lg-4">
							<div class="content-img-text">
								<img src="img/ae-cheminee-exterieur.jpg" alt="Photo Aménagement Extérieur">
								<p class="paragraphe big-p text-center">Cheminée d'extérieur</p>
							</div>
						</div>
						<div class="col-12 col-md-6 col-lg-4">
							<div class="content-img-text">
						...
						<div class="col-12 col-md-6 col-lg-4">
							<div class="content-img-text">
								<img src="img/ae-terrasse.jpg" alt="Photo Aménagement Extérieur">
								<p class="paragraphe big-p text-center">Terrasse parfaitement intégrée</p>
							</div>
						</div>
					</div>
				</div>
